...
class CityListFragment : Fragment(),
    MyCityListRecyclerViewAdapter.OnListInteractionListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(recyclerViewList) {
            ...
            adapter =
                MyCityListRecyclerViewAdapter(
                    list,
                    this@CityListFragment
                )
    ...
    override fun onItemClicked(weatherCityInfo: WeatherCityInfo) {
        val directions =
            CityListFragmentDirections.actionCityListFragmentToCityWeatherDetailFragment(
                weatherCityInfo
            )
